...
sub sayNameAsUppercase {
  my ($first, $second) = @_;
  say(uc($first), $second);
}

sayNameAsUppercase("Thadryan", "Sweeney");
sayNameAsUppercase("Libin", "Huang");
sayNameAsUppercase("Chesley", "Leslin");
...
my @nameList = ("Thadryan", "Libin", "Chesley");
